...
class _Login extends State<Login> {
  ...
  void setDataForSignUpInUsers(UserModel item) async {
    ...
    sharedPreferences.setString('fname',item.fname!=null?item.fname: '');
    sharedPreferences.setString('lname',item.lname!=null?item.lname: '');
    sharedPreferences.setString('email',item.email!=null?item.email: '');
    sharedPreferences.setString('mobileno',item.mobileno!=null?item.mobileno: '');
    sharedPreferences.setString('groupcd',item.groupcd!=null?item.groupcd: '');
  }
}