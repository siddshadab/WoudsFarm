...
import 'package:wouds_farm/widgets/animated_dialog_box.dart';
...
class OtpPageState extends State<OtpPage> {
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      widget.phoneNumber,
                      style: TextStyle(
                          fontSize: 15.0, fontWeight: FontWeight.bold, color: Colors.brown),
                      textAlign: TextAlign.center,),
                  ),
  ...
  Future<dynamic> matchOtp() async{
    return animated_dialog_box.showInOutDailog(
        title: Center(child: Text("Successfully")), // IF YOU WANT TO ADD
        context: context,
        ...
        yourWidget: Container(
          child: Text("Otp matched successfully."),
        ));
  }
}