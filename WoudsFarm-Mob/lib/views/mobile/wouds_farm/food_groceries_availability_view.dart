...
import 'package:wouds_farm/views/mobile/wouds_farm/genie/genie_screen.dart';
import 'package:wouds_farm/widgets/responsive.dart';
              ...
              children: <Widget>[
                ...
                Flexible(
                  child: Column(
                    children: <Widget>[
                      Text(
                        'We are now deliverying Fresh Chicken and other parts related to chicken.',
                        style: Theme.of(context).textTheme.headline4,
                      ),
                      UIHelper.verticalSpaceSmall(),
                      Text(
                        'Fresh chicken Dileery service',
