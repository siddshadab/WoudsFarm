...
class FarmerBulkDetailedList extends StatefulWidget {
  bool _isInit = true;
  LiveChickenModelFromServer data ;

  @override
  _FarmerBulkDetailedList createState() => _FarmerBulkDetailedList();
}

class _FarmerBulkDetailedList extends State<FarmerBulkDetailedList> {
