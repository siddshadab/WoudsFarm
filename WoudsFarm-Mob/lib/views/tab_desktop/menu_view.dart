...
import 'package:wouds_farm/models/tab_desktop/menu.dart';
import 'package:wouds_farm/utils/app_colors.dart';
                    ...
                    child: SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          onPrimary: wouds_farmOrange,
                          side: BorderSide(width: 2.0, color: wouds_farmOrange!),
    ...
    return Container(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: isTab
              ? IconButton(
                  icon: Icon(widget.menu.icon, color: isHovered ? wouds_farmOrange : Colors.black),
                  iconSize: 30.0,
                  onPressed: () {},
                )
              : Row(
                  ...
                  children: [
                    Icon(widget.menu.icon, color: isHovered ? wouds_farmOrange : Colors.black, size: 30.0),
                    UIHelper.horizontalSpaceMedium(),
                    Text(
                      widget.menu.title,
                      style: Theme.of(context).textTheme.headline6!.copyWith(
                            color: isHovered ? wouds_farmOrange : Colors.black,
                          ),
                    ),
                  ],
                ),
